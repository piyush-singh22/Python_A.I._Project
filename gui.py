...
class ProjectRunnerGUI:
    ...
    def create_voice_button(self):
        ...
        voice_button = tk.Button(self.root, text="Voice assistant", cursor="hand2", command=self.run_voice_assistant)
...
if __name__ == "__main__":
    ...
    root.geometry("620x515")    # it is in the form of width x height
